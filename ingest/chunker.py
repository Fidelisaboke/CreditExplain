...
class RegulatoryChunker:
    ...
    def _enhance_regulatory_chunks(self, chunks: List[Document], original_metadata: Dict[str, Any]) -> List[Document]:
        """
    ...
    def _determine_chunk_type(self, text: str) -> str:
        ...
        if any(keyword in text_lower for keyword in ["definition", "means", "shall mean"]):
            return "definition"
        elif any(keyword in text_lower for keyword in ["prohibit", "must not", "shall not"]):
            return "prohibition"
            ...
            return "enforcement"
        elif any(keyword in text_lower for keyword in ["exception", "provided that", "unless"]):
            return "exception"
        else:
            return "general"
...
if __name__ == "__main__":
    ...
    documents = [Document(page_content=rule["text"], metadata=rule) for rule in sample_rules]
