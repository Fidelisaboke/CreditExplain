...
def test_vector_retriever_initialization():
    ...
    with patch('core.retrieval.HuggingFaceEmbeddings') as mock_embeddings, \
         patch('core.retrieval.Chroma') as mock_chroma:
...
def test_retrieve_error_handling(mock_logger):
    ...
    with patch('core.retrieval.HuggingFaceEmbeddings') as mock_embeddings, \
        ...
        mock_chroma_instance.similarity_search_by_vector.side_effect = Exception("Test error")
